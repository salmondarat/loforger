...
export const COMPATIBILITY_RULES: CompatibilityRule[] = [
	{
		...
		check: (a) =>
			a.frontend_framework === "nextjs" && a.backend_framework === "laravel",
		reason:
			"Next.js has built-in API Routes. Adding Laravel means managing two servers and two languages.",
		suggestion:
			"Use Next.js API Routes for fullstack, or Laravel + Inertia.js for traditional fullstack.",
	...
	},
	{
		...
		reason:
			"Prisma is a SQL ORM - it cannot work with Firestore (NoSQL document database).",
		suggestion:
			"Use Firebase SDK directly, or switch to PostgreSQL to use Prisma.",
	...
	},
	{
		...
		reason:
			"SQLite does not handle concurrent writes well for multi-user production apps.",
		suggestion:
			"Use PostgreSQL (Supabase, Neon, Railway) for production deployments.",
	...
	},
	{
		...
		check: (a) =>
			a.auth_provider === "nextauth" && a.frontend_framework !== "nextjs",
		reason: "NextAuth is designed specifically for Next.js ecosystem.",
		suggestion:
			"Use Lucia Auth, Better Auth, or Clerk for non-Next.js frameworks.",
	...
	},
	{
		...
		check: (a) => {
			...
			const hasTrpc = Array.isArray(apiStyle)
				? apiStyle.includes("trpc")
				: apiStyle === "trpc";
	...
	},
	{
		...
		reason:
			"Firebase is a managed Google Cloud service - it cannot be self-hosted.",
		suggestion:
			"Use Supabase self-hosted, PocketBase, or Appwrite for full self-hosting.",
	...
	},
	{
		...
		reason:
			"Kubernetes is complex to set up and maintain for a solo dev or small team.",
		suggestion:
			"Use Vercel/Railway/Render for hosted deployment, or Docker Compose for local dev.",
	...
	},
	{
		...
		reason:
			"Two different API layers for the same purpose adds complexity without clear benefit.",
		suggestion:
			"Choose one: tRPC for simple fullstack TypeScript, or GraphQL for multiple API consumers.",
